...
Yet that's not all. The program included musics implemented using PyGames. You can also choose between battling the aforementioned bot or battle another human being, if you have friends to play with. You start by choosing how many rounds you'd like to play, then choosing who you're fighting with. Trust me, it's not complicated. There's only around 263 lines of code. I'm sure someone could create a more efficiency program, but i don't care. Here's the entire code.
